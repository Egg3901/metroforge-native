...
pub struct Strings {
    ...
    pub tool_depot: &'static str,
    pub tool_depot_context: &'static str,
    ...
    pub frequency_heading: &'static str,
    pub frequency_hint: &'static str,
    pub running_now: &'static str,
    pub peak_units_needed: &'static str,
    pub period_am_peak: &'static str,
    pub period_midday: &'static str,
    pub period_pm_peak: &'static str,
    pub period_evening: &'static str,
    pub period_night: &'static str,
    pub fare: &'static str,
    ...
    pub finance_tab_overview: &'static str,
    pub finance_tab_trends: &'static str,
    pub trends_daily_net: &'static str,
    pub trends_ridership_routes: &'static str,
    pub trends_share_population: &'static str,
    pub trends_no_routes: &'static str,
...
pub static EN: Strings = Strings {
    ...
    net_per_day: "Net / day",
    vehicles: "Vehicles",
    frequency_heading: "Service frequency",
    frequency_hint: "Minutes between vehicles by time of day. More service draws riders but needs more vehicles.",
    running_now: "Running now",
    peak_units_needed: "Peak units needed",
    period_am_peak: "AM peak",
    period_midday: "Midday",
    period_pm_peak: "PM peak",
    ...
    finance_tab_trends: "Trends",
    trends_daily_net: "Daily net",
    trends_ridership_routes: "Ridership by route (top 8)",
    trends_share_population: "Transit share and population",
    trends_no_routes: "No routes yet.",
...
pub fn all_static_strings(s: &Strings) -> Vec<&'static str> {
    vec![
        ...
        s.net,
        s.net_last_7_days,
        s.finance_tab_overview,
        s.finance_tab_trends,
        s.trends_daily_net,
        s.trends_ridership_routes,
        s.trends_share_population,
        s.trends_no_routes,
        s.population,
        s.transit_share,
        s.coverage,
